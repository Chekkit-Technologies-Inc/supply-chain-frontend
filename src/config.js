...
// export const REACT_APP_ASSET_MANAGEMNET_URL = 'https://asset-management.chekkit.app/#';

// export const REACT_APP_ASSET_MANAGEMNET_URL = 'http://localhost:3002/#';

export const REACT_APP_ASSET_MANAGEMNET_URL = 'https://happy-pond-0ca78e203.2.azurestaticapps.net/#';
