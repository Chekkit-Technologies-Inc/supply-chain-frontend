            ...
            <div className='p-4 md:px-12 bg-white border-b border-gray-100'>
              <div className='flex justify-between items-center'>
                ...
                <div className='flex items-center space-x-3 sm:space-x-6'>
                  <div className='flex items-center space-x-3 sm:space-x-6'>
                    <div onClick={() => history.push('/settings')} className='w-10 h-10 cursor-pointer'>
                      <SettingsIcon className='w-full h-full' />
                    </div>
                    <div onClick={signout} className='w-10 h-10 cursor-pointer'>
                  ...
                  .map(item => (
                    <Link
                      ...
                      className={classNames(
                        ...
                        'group flex items-center p-4 text-sm font-medium rounded-xl',
                      )}
                    >
                      <item.icon
