        ...
        <div className={`flex flex-col items-center justify-center space-y-12`}>
          ...
          <ul className={`flex flex-col space-y-12 xl:space-y-0 xl:flex-row xl:space-x-24 circle_item`}>
            <li className={`space-y-6 pl-4`}>
              ...
              <Text className={`max-w-md text text-gray-600`} value={`When your field agent goes to the field for monthly visit, they wull be able to scan this sticker oFF the asset and answer pertinent qustions you might be curious about`} />
            </li>
            <li className={`space-y-6 pl-4`}>
