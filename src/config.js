...
// export const apiUrl = 'https://chekkitsupplychain.azurewebsites.net/api/v1';

export const REACT_APP_MAP_API_KEY = 'AIzaSyBIhKt7YhWM0qAcLZrIAJGmrqnJLs8dT8E';

export const REACT_APP_ASSET_MANAGEMNET_URL = 'https://asset-management.chektrack.com/#';
...
// 9d80524c-7800-48b0-8fea-f6c0dae4198b
